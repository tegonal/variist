 ...
 * @param A2 the type of values generated by the [other]&nbsp;[SemiOrderedArgsGenerator].
 * @param R the type of values generated by the resulting [SemiOrderedArgsGenerator].
 *
 * @return The resulting [SemiOrderedArgsGenerator] which represents the cross product and generates values of type [R].
 *
 * @since 2.0.0
 */
