...
private fun <T> concatAll(iterator: Iterator<OrderedArgsGenerator<T>>): OrderedArgsGenerator<T> {
	...
	while (iterator.hasNext()) {
		//TODO 3.5.0 would it be worth to introduce a Concatenator which takes n OrderedArgsGenerator instead of just 2?
...
operator fun <T> OrderedArgsGenerator<T>.plus(
	...
	//TODO 3.5.0 bench when it makes sense to materialise instead of concatenation, for small sizes it could be faster
